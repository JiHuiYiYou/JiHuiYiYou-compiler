...
**新增 4 fixture + 2 bootstrap script** (Phase 5, commit `TBD`):
...
- regress delta 100/115 → **107/146 PASS** (+7: 4 新 fixture + 1 cross-cluster impulse + 2 pre-existing skip 取消-recover)
