...
**ID:** W-086
**状态:** 🟡 DEFERRED-pending-Commit-2 2026-09-23 (v3.0.7/Commit 1 wholesale merge-file + strcmp migration + state cast + emit_conv comment drop ship; Commit 2 2-op rewrite ship → 🟡 → ✅)
