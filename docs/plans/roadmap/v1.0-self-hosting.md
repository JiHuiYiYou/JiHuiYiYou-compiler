...
| **Stage 1** | `diff jhyy_0.il jhyy_1.il` **byte-equal**（jhyy_0 vs jhyy_1 编同一 .jhyy 产 .il 字节相等） | 🔴 v0.9 目标 | v0.9 sprint 4 |
| **Stage 2** | `jhyy_1` 编 `compiler/src0/main.jhyy` 跑 regress = **持平 baseline**（12 OK 持平即可，**不是** 47/47） | 🔴 v1.0 目标 | v1.0 sprint 5 |
...
> **本节已被 lang-spec v1.0.0 附录 C 取代**。v1.x 启动条件（lang-spec § 附录 C 行 1132-1137）：
